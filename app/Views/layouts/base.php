...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url() ?>stisla/assets/css/select2-bootstrap4.min.css">
...
<body>
            ...
            <div class="main-sidebar sidebar-style-2">
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        <a href="<?= base_url('index'); ?>">DocuKeep</a>
                    </div>
                    <div class="sidebar-brand sidebar-brand-sm">
                        <a href="<?= base_url('index'); ?>">St</a>
                    </div>
                    <ul class="sidebar-menu">
                        ...
                        <li class="nav-item dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                <li class="active"><a class="nav-link" href="<?= base_url('index'); ?>">General Dashboard</a></li>
                            </ul>
                        </li>
                        <li class="menu-header">Rekam Medis</li>
                        <li><a class="nav-link" href="<?= base_url('input/upload'); ?>"><i class="fas fa-file-upload"></i> <span>Upload Dokumen</span></a></li>
                        <li><a class="nav-link" href="<?= base_url('preview/lihat'); ?>"><i class="far fa-square"></i> <span>Lihat Rekam Medis</span></a></li>
                    </ul>
    ...
    <script src="<?= base_url() ?>stisla/node_modules/select2/dist/js/select2.min.js"></script>
